...
module.exports = class InteractionCreateEvent extends BaseEvent {
  ...
  async run(client, interaction) {
    ...
    if (interaction.customId == "claim6") {
      if (!interaction.member.roles.cache.has("1133733175093379184")) return
      ...
      interaction.channel.permissionOverwrites.edit("1133733175093379184", {
        ViewChannel: false
      })
 ...
 - تـم ترك تـذكـرتـك مـن قـبـل الإداري  : __** ${interaction.member}`)
  ...
  `)
    ...
    if (interaction.customId == "delete6") {
      if (!interaction.member.roles.cache.has("1133733175093379184")) return
